      ...
      """#
                ...
                struct User {
                  ...
                  public nonisolated struct TableColumns: StructuredQueriesPostgresCore.TableDefinition, StructuredQueriesPostgresCore.PrimaryKeyedTableDefinition {
                    ...
                    public let id = StructuredQueriesPostgresCore.TableColumn<QueryValue, UUID>("id", keyPath: \QueryValue.id)
                    ...
                    public var primaryKey: StructuredQueriesPostgresCore.TableColumn<QueryValue, UUID> {
                      self.id
                    }
      ...
      """#
                ...
                struct Product {
                  ...
                  public nonisolated struct TableColumns: StructuredQueriesPostgresCore.TableDefinition, StructuredQueriesPostgresCore.PrimaryKeyedTableDefinition {
                    ...
                    public let name = StructuredQueriesPostgresCore.TableColumn<QueryValue, String>("name", keyPath: \QueryValue.name)
                    public let price = StructuredQueriesPostgresCore.TableColumn<QueryValue, Double>("price", keyPath: \QueryValue.price)
                ...
                nonisolated extension Product: StructuredQueriesPostgresCore.Table, StructuredQueriesPostgresCore.PrimaryKeyedTable {
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
                  }
                  public nonisolated static var tableName: String {
      ...
      """#
                ...
                struct StripeEvent {
                  ...
                  public nonisolated struct TableColumns: StructuredQueriesPostgresCore.TableDefinition, StructuredQueriesPostgresCore.PrimaryKeyedTableDefinition {
                    ...
                    public let id = StructuredQueriesPostgresCore.TableColumn<QueryValue, String>("id", keyPath: \QueryValue.id)
                    public let type = StructuredQueriesPostgresCore.TableColumn<QueryValue, String>("type", keyPath: \QueryValue.type)
                    public let processedAt = StructuredQueriesPostgresCore.TableColumn<QueryValue, Date>("processedAt", keyPath: \QueryValue.processedAt)
                    public var primaryKey: StructuredQueriesPostgresCore.TableColumn<QueryValue, String> {
                      self.id
                    }
                    public static var allColumns: [any StructuredQueriesPostgresCore.TableColumnExpression] {
                ...
                nonisolated extension StripeEvent: StructuredQueriesPostgresCore.Table, StructuredQueriesPostgresCore.PrimaryKeyedTable {
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
                  }
                  public nonisolated static var tableName: String {
      ...
      """#
                ...
                struct Order {
                  ...
                  public nonisolated struct TableColumns: StructuredQueriesPostgresCore.TableDefinition {
                    ...
                    public let orderId = StructuredQueriesPostgresCore.TableColumn<QueryValue, Int>("orderId", keyPath: \QueryValue.orderId)
                    public let customerId = StructuredQueriesPostgresCore.TableColumn<QueryValue, UUID>("customerId", keyPath: \QueryValue.customerId)
                    public let total = StructuredQueriesPostgresCore.TableColumn<QueryValue, Double>("total", keyPath: \QueryValue.total)
                    public static var allColumns: [any StructuredQueriesPostgresCore.TableColumnExpression] {
                ...
                nonisolated extension Order: StructuredQueriesPostgresCore.Table {
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
                  }
                  public nonisolated static var tableName: String {
