...
//        ("id", "name", "duration")
//        VALUES
//        ('\u{07AD}��ޭ��ޭ��ޭ��', '', <invalid: The operation couldn’t be completed. (StructuredQueriesPostgresCore.OverflowError error 1.)>)
//        RETURNING "id", "name", "duration"
//        """#
//            } results: {
//        """
//        The operation couldn’t be completed. (StructuredQueriesPostgresCore.OverflowError error 1.)
//        """
//            }
//        }
//        
