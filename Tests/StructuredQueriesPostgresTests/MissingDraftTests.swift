    ...
    @Suite struct MissingDraftTests {
        ...
        @Test func draftWithUUIDPrimaryKey() {
            ...
            assertInlineSnapshot(
                ...
                ("name", "createdAt")
                VALUES
                ('UUID Test', '2040-02-14 23:31:30.000')
                """
            }
        }
        ...
        @Test func draftInsertReturningAllColumns() {
            ...
            assertInlineSnapshot(
                ...
                VALUES
                (NULL, NULL, false, false, '', NULL, 1, 'Return all', '2040-02-14 23:31:30.000')
        ...
        @Test func draftInsertReturningGeneratedId() {
            ...
            assertInlineSnapshot(
                ...
                ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                VALUES
                (NULL, NULL, false, false, '', NULL, 1, 'Return ID', '2040-02-14 23:31:30.000')
                RETURNING "id"
                """
            }
        }
        ...
        @Test func draftInsertReturningMultipleColumns() {
            ...
            assertInlineSnapshot(
                ...
                ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                VALUES
                (NULL, NULL, false, false, '', NULL, 1, 'Return multiple', '2040-02-14 23:31:30.000')
        ...
        @Test func allDraftsBatchInsert() {
            ...
            assertInlineSnapshot(
                ...
                ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                VALUES
                (NULL, NULL, false, false, '', NULL, 1, 'Batch Draft 1', '2040-02-14 23:31:30.000'), (NULL, NULL, false, false, '', NULL, 1, 'Batch Draft 2', '2040-02-14 23:31:30.000'), (NULL, NULL, false, false, '', NULL, 1, 'Batch Draft 3', '2040-02-14 23:31:30.000'), (NULL, NULL, false, false, '', NULL, 1, 'Batch Draft 4', '2040-02-14 23:31:30.000'), (NULL, NULL, false, false, '', NULL, 1, 'Batch Draft 5', '2040-02-14 23:31:30.000')
                """
            }
        }
        ...
        @Test func cteWithDraftInsert() {
            ...
            assertInlineSnapshot(
                ...
                WITH new_reminders AS (
                  ...
                  ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                  VALUES
                  (NULL, NULL, false, false, '', NULL, 1, 'CTE Draft', '2040-02-14 23:31:30.000')
                  RETURNING "id"
                )
                )
                SELECT * FROM new_reminders
        ...
        @Test func multipleCTEsWithDrafts() {
            ...
            assertInlineSnapshot(
                ...
                first_insert AS (
                  ...
                  ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                  VALUES
                  (NULL, NULL, false, false, '', NULL, 1, 'First', '2040-02-14 23:31:30.000')
                  RETURNING "id"
                )
                ),
                second_insert AS (
                  ...
                  ("assignedUserID", "dueDate", "isCompleted", "isFlagged", "notes", "priority", "remindersListID", "title", "updatedAt")
                  VALUES
                  (NULL, NULL, false, false, '', NULL, 2, 'Second', '2040-02-14 23:31:30.000')
                  RETURNING "id"
                )
                )
                SELECT * FROM first_insert
