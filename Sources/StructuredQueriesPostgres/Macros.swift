...
/// Defines and implements a conformance to the ``/StructuredQueriesPostgresCore/Table`` protocol.
///
...
/// Customizes a column generated by the ``/StructuredQueriesPostgresCore/Table`` protocol.
///
/// - Parameters:
