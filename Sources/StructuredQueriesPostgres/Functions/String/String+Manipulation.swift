...
extension PostgreSQL.String {
    ...
    public static func reverse(_ value: some QueryExpression<Swift.String>) -> some QueryExpression<Swift.String> {
        SQLQueryExpression(
...
extension QueryExpression where QueryValue == Swift.String {
    ...
    ///   - newSubstring: The replacement substring
    /// - Returns: The string with all occurrences replaced
    public func replacing(_ substring: Swift.String, with newSubstring: Swift.String) -> some QueryExpression<Swift.String> {
