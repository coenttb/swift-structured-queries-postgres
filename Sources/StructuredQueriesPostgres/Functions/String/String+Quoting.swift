...
extension PostgreSQL.String {
    ...
    public static func quote(_ value: some QueryExpression<Swift.String>) -> some QueryExpression<Swift.String> {
    ...
    public static func quoteLiteral(_ value: some QueryExpression<Swift.String>) -> some QueryExpression<Swift.String> {
        SQLQueryExpression(
    ...
    public static func quoteIdent(_ value: some QueryExpression<Swift.String>) -> some QueryExpression<Swift.String> {
        SQLQueryExpression(
