...
extension QueryExpression where QueryValue == Swift.String {
    ...
    ///   - fill: Fill string (defaults to space)
    /// - Returns: The padded string
    public func lpad(to length: Int, with fill: Swift.String = " ") -> some QueryExpression<Swift.String> {
    ...
    ///   - fill: Fill string (defaults to space)
    /// - Returns: The padded string
    public func rpad(to length: Int, with fill: Swift.String = " ") -> some QueryExpression<Swift.String> {
