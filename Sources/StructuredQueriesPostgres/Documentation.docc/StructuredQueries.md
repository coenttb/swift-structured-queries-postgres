...
[`StructuredQueriesPostgresCore`](<doc:/StructuredQueriesPostgresCore>), which this module automatically exports.

This module also contains all of the macros that support the core functionality of the library.

See [`StructuredQueriesPostgresCore`](<doc:/StructuredQueriesPostgresCore>) for general library usage.
